...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        select.style.backgroundImage = 'url("images/phoebe.png")';   
        //Active player may only be 'X' or 'O' so, if not 'X' it must be 'O'
        } else {    
        //If activePlayer is equal to 'O', the o.png is placed in HTML.
        select.style.backgroundImage = 'url("images/chi.png")';
        }
...
//This function makes our body element temporily unclickable.
...
//This function utlizes html canvas win lines.
...
//This line accesses our html canvas element.
    ...
    let xl = coordXl,
        ...
        x = xl,
        //This variable stores temporary y axis data we upate in our animation loop.
        y = yl;
    ...
    function animateLineDrawing() {
        ...
        //This method draws everything we laid out adove.
        c.stroke();
